...
class Targetting(models.Model):
    ...
    alignment = models.CharField(max_length=10, choices=("Friendly", "Enemy", "Any"))

    # whether an unit should be on top of that square or not
    occupant = models.CharField(max_length=10, choices=("Occupied", "Unit", "Rubble", "Empty", "Any"))
    ...
    location = models.CharField(max_length=10, choices=("Chosen", "Random", "All"))
...
class Unit(models.Model):
    ...
    ## on their own
    attack_type = models.CharField(max_length=10, choices=("Melee", "Ranged", "Defender"))
